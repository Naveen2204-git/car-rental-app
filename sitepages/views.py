...
def Home(request):
    ...
    data = {'ptitle' : 'Naveen Prestige Autos - Home','cars': six_cars}

    return render(request,'sitepages/index.html',data)


def About(request):
    data = {'ptitle' : 'Naveen Prestige Autos - About'}

    return render(request,'sitepages/about.html',data)

def Service(request):
    data = {'ptitle' : 'Naveen Prestige Autos - Service'}
...
def Car(request):
    cars = list(Cars.objects.all())
    random.shuffle(cars)  # Shuffle the list of cars
    data = {'ptitle' : 'Naveen Prestige Autos - Cars','cars': cars}
...
def Contact(request):
    ...
    data = {'ptitle': 'Naveen Prestige Autos - Contact'}
...
def Car_details(request, car_slug):
    ...
    ptitle = f"Naveen Prestige Autos - {car.name} Details"
...
def car_search(request):
    ...
    data = {'ptitle' : 'Naveen Prestige Autos - Search Results','cars': cars}
...
def cars_by_brand(request, brand_name):
    ...
    data = {'ptitle': 'Naveen Prestige Autos - Car Brands'}
